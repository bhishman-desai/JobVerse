    ...
    >
      ...
      >
        <Text fontSize={{ base: "2xl", sm: "3xl", md: "4xl" }} mb={4}>
          You are a <Text as="span" color="green.400">candidate</Text> looking for your dream job?
        </Text>
        ...
        <Stack spacing={4} width="100%" maxWidth="600px" mb={8}>
          <Input placeholder="Job title, Keywords" variant="filled" backgroundColor="white" color="white"/>

          <Button colorScheme="green" size="lg">Search</Button>
        </Stack>

        <Text fontSize={{ base: "2xl", sm: "3xl", md: "4xl" }} mb={4}>
          You are an <Text as="span" color="blue.400">employer</Text> looking for the perfect candidate?
        </Text>
        <Text fontSize={{ base: "lg", sm: "xl", md: "2xl" }} mb={8}>
          Post your job now!
        </Text>
        <Button colorScheme="blue" size="lg">I want to recruit now!</Button>
      </Flex>
    </Box>
  );
}
